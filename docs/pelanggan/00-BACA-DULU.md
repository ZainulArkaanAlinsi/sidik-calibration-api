...
| U2 | **Kedua repo bisa di-clone tanpa login** per 16 Sep 2026, padahal `CLAUDE.md` mencatat repo API sudah privat sejak 10 Sep. | Isi `Project-PT-Sidik/` (lampiran akreditasi, lembar kerja, workbook) ikut terbuka. Kalau dibuka sengaja supaya bisa dibaca untuk dokumen ini, balikkan lagi. | Set privat, jalankan pemindai secret di seluruh histori git. Task M0-01. |
