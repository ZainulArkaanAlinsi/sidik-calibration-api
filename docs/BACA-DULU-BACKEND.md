...
| **Matriks peran** | `GET /me/permissions` — `boleh[]` (daftar putih nama izin) + `batasan{}` (`sendiri`/`semua`). Dihitung dari middleware rute, jadi nggak bisa basi. Admin 51 · teknisi 24 · viewer 15. Lihat [`kontrak-api.md` §2](kontrak-api.md) |
