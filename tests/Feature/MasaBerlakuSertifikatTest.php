...
class MasaBerlakuSertifikatTest extends TestCase
{
    ...
    /** Approve meneruskan pilihan admin ke job tanpa menunggu render PDF. */
    public function test_admin_bisa_nentuin_tanggal_sendiri_waktu_approve(): void
    {
        ...
        Queue::assertPushed(GenerateCertificate::class, function (GenerateCertificate $job) use ($sesi): bool {
            return $job->calibrationSessionId === $sesi->id
    ...
    public function test_tanpa_berlaku_sampai_tetap_jalan_pakai_default(): void
    {
        ...
        Queue::assertPushed(GenerateCertificate::class, function (GenerateCertificate $job) use ($sesi): bool {
            return $job->calibrationSessionId === $sesi->id && $job->berlakuSampai === null;
        });
    }
